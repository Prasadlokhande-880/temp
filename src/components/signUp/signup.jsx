            ...
            <form className="space-y-2 md:space-y-4" action="#">
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                <span className="p-0 m-0 text-[#666] text-[12px] not-italic font-normal leading-3">
              ...
              <div className="p-0 m-0 flex flex-wrap">
                <button
                  ...
                  type="submit"
                  className="font-medium text-sm p-2 px-5 m-3 border-solid border-2 bg-[#CAC7CF] text-[#626069] rounded-full hover:bg-blue-900 hover:text-white focus:ring-4 focus:outline-none focus:ring-primary-500 transition delay-100 duration-300 ease-in-out"
                >
                  Sign Up
                </button>

...
const WhyLR = ({ number, title, text }) => {
  return (
    ...
    // </section>
    <section className="section ">
      <div className="flex flex-col items-center justify-center w-full h-max xl:flex-row xl:py-8 xl:px-48 xl:justify-between">
        ...
        <div className="w-full flex flex-row justify-center xl:justify-end items-center xl:w-1/2">
